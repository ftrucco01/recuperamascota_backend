...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-6 col-xl-7 d-flex align-items-center justify-content-md-start justify-content-center">
                            <div class="banner-img">
                                <img class="img-fluid" src="assets/images/bg/new-banner-img.png" alt="">
                            </div>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="single-review">
                                                <div class="icon">
                                                    <img src="assets/images/icon/trustpilot001.svg" alt="">
                                                    <span>reviews</span>
                                                </div>
                                                <div class="reviews">
                                                    <ul>
            ...
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-center">
                    <div class="section-title1 text-center">
                        <span><img src="assets/images/icon/section-vec-l1.svg" alt="">Services<img src="assets/images/icon/section-vec-r1.svg" alt=""></span>
                ...
                <div class="col-lg-12">
                    <div class="newsletter-wrap">
                        <div class="section-title1 text-center mb-40">
                            <span><img src="assets/images/icon/section-vec-l1.svg" alt="">Get In Touch<img src="assets/images/icon/section-vec-r1.svg" alt=""></span>
    ...
    <div class="h1-blog-area mb-120">
        <div class="container">
            <div class="row mb-50">
                <div class="col-lg-12 d-flex justify-content-center">
                    <div class="section-title1 text-center">
                        <span><img src="assets/images/icon/section-vec-l2.svg" alt="">Latest Blog<img src="assets/images/icon/section-vec-r2.svg" alt=""></span>
            ...
            <div class="row g-lg-4 gy-5 justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="h1-blog-card">
                        <div class="blog-img">
                            <img class="img-fluid" src="assets/images/blog/blog1.png" alt="">
                            <div class="category">
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="h1-blog-card">
                        <div class="blog-img">
                            <img class="img-fluid" src="assets/images/blog/blog2.png" alt="">
                            <div class="category">
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="h1-blog-card">
                        <div class="blog-img">
                            <img class="img-fluid" src="assets/images/blog/blog3.png" alt="">
                            <div class="category">
    ...
    <div class="gallery-img-area">
        <div class="swiper gallery-1">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <a href="assets/images/bg/gallery/gallery-11.png" data-fancybox="gallery" class="gallery2-img">
                        <div class="gallery-img">
                            <img class="img-fluid" src="assets/images/bg/gallery/gallery-1.png" alt="">
                            <div class="overlay">
                                <div class="zoom-icon">
                ...
                <div class="swiper-slide">
                    <a href="assets/images/bg/gallery/gallery-22.png" data-fancybox="gallery" class="gallery2-img">
                        <div class="gallery-img">
                            <img class="img-fluid" src="assets/images/bg/gallery/gallery-2.png" alt="">
                            <div class="overlay">
                                <div class="zoom-icon">
                                    <i class="bi bi-zoom-in"></i>
                                </div>
                ...
                <div class="swiper-slide">
                    <a href="assets/images/bg/gallery/gallery-33.png" data-fancybox="gallery" class="gallery2-img">
                        <div class="gallery-img">
                            <img class="img-fluid" src="assets/images/bg/gallery/gallery-3.png" alt="">
                            <div class="overlay">
                                <div class="zoom-icon">
                                    <i class="bi bi-zoom-in"></i>
                                </div>
                ...
                <div class="swiper-slide">
                    <a href="assets/images/bg/gallery/gallery-44.png" data-fancybox="gallery" class="gallery2-img">
                        <div class="gallery-img">
                            <img class="img-fluid" src="assets/images/bg/gallery/gallery-4.png" alt="">
                            <div class="overlay">
                                <div class="zoom-icon">
                                    <i class="bi bi-zoom-in"></i>
                                </div>
                ...
                <div class="swiper-slide">
                    <a href="assets/images/bg/gallery/gallery-55.png" data-fancybox="gallery" class="gallery2-img">
                        <div class="gallery-img">
                            <img class="img-fluid" src="assets/images/bg/gallery/gallery-5.png" alt="">
                            <div class="overlay">
                                <div class="zoom-icon">
                                    <i class="bi bi-zoom-in"></i>
                                </div>
                ...
                <div class="swiper-slide">
                    <a href="assets/images/bg/gallery/gallery-66.png" data-fancybox="gallery" class="gallery2-img">
                        <div class="gallery-img">
                            <img class="img-fluid" src="assets/images/bg/gallery/gallery-6.png" alt="">
                            <div class="overlay">
                                <div class="zoom-icon">
                                    <i class="bi bi-zoom-in"></i>
                                </div>
                ...
                <div class="swiper-slide">
                    <a href="assets/images/bg/gallery/gallery-77.png" data-fancybox="gallery" class="gallery2-img">
                        <div class="gallery-img">
                            <img class="img-fluid" src="assets/images/bg/gallery/gallery-7.png" alt="">
                            <div class="overlay">
                                <div class="zoom-icon">
                                    <i class="bi bi-zoom-in"></i>
                                </div>
                ...
                <div class="swiper-slide">
                    <a href="assets/images/bg/gallery/gallery-88.png" data-fancybox="gallery" class="gallery2-img">
                        <div class="gallery-img">
                            <img class="img-fluid" src="assets/images/bg/gallery/gallery-8.png" alt="">
                            <div class="overlay">
                                <div class="zoom-icon">
                                    <i class="bi bi-zoom-in"></i>
                                </div>
                ...
                <div class="swiper-slide">
                    <a href="assets/images/bg/gallery/gallery-99.png" data-fancybox="gallery" class="gallery2-img">
                        <div class="gallery-img">
                            <img class="img-fluid" src="assets/images/bg/gallery/gallery-9.png" alt="">
                            <div class="overlay">
                                <div class="zoom-icon">
                                    <i class="bi bi-zoom-in"></i>
                                </div>
